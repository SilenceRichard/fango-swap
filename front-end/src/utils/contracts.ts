...
/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link poolAbi}__ and `functionName` set to `"pools"`
 */
export const useReadPoolPools = /*#__PURE__*/ createUseReadContract({
  abi: poolAbi,
  functionName: 'pools',
})
